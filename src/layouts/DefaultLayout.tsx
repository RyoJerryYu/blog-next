...
const FooterIcon = (svgPath: string) => {
  const f = ({ href, title }: IconItem) => {
    return (
      ...
      <MainWidth className="w-full">
        <div className="flex flex-row justify-center items-center">
          ...
          <div className={style.footerRight}>
            <TwitterIcon href="https://twitter.com/ryo_okami" title="Twitter" />
            <GitHubIcon href="https://github.com/RyoJerryYu" title="GitHub" />
          </div>
        </div>
      </MainWidth>
    </footer>
